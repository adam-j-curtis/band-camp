...
triple_roll = Assignment.create(name: "Triple Stroke Roll", description: "")
...
AssignmentInstrumentSection.create(assignment: scale_e_flat, instrument_section: flute)
AssignmentInstrumentSection.create(assignment: scale_f_sharp, instrument_section: trombone)
AssignmentInstrumentSection.create(assignment: scale_f, instrument_section: trumpet)
AssignmentInstrumentSection.create(assignment: triple_roll, instrument_section: snare)
